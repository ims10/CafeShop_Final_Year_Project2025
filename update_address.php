...
<body>
   ...
   <section class="form-container">
      ...
      <form action="" method="post">
         ...
         <input type="text" class="box" placeholder="road name" required maxlength="50" name="state">
         <input type="text" class="box" placeholder="country name" required maxlength="50" name="country">
         <input type="number" class="box" placeholder="post code" required max="999999" min="0" maxlength="6" name="pin_code">
